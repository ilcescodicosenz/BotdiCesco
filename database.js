...
class Database {
  ...
  // Nuova funzione: Aggiungere una voce al database
  add(key, value) {
    this._data[key] = value;
    this.save();
  }

  // Nuova funzione: Rimuovere una voce dal database
  remove(key) {
    delete this._data[key];
    this.save();
  }

  // Nuova funzione: Trovare una voce nel database
  find(key) {
    return this._data[key] || null;
  }

  // Nuova funzione: Verifica se una chiave esiste
  exists(key) {
