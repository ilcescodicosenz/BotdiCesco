...
const handler = async (message, { conn, usedPrefix }) => {
    // Controlla se il messaggio proviene dall'utente corretto
    ...
    // Risponde al messaggio dell'utente
    ...
    try {
        ...
        // Risposta in base al numero di file eliminati
        if (deletedCount === 0) {
