...
(function (_0x5036f1, _0x321bf8) {
    ...
    while (true) {
        try {
            ...
            if (_0x27c87b === _0x321bf8) break;
            else _0x572665.push(_0x572665.shift());
        } catch (_0x159d29) {
...
let handler = async (_0x316f52, { conn: _0x4a2566, usedPrefix: _0x238280 }) => {
    const _0x109283 = _0x266e;

    let uptimeMilliseconds = process.uptime() * 1000;
    let uptimeString = clockString(uptimeMilliseconds);
    
    const totalUsers = Object.keys(global.db.data.users).length;
    const activeChats = Object.entries(_0x4a2566.chats).filter(([_0x5e8870, _0x10b39e]) => _0x5e8870 && _0x10b39e.isChats);
    
    let startTime = performance.now();
    await _0x4a2566.sendMessage(_0x316f52.sender, 'Fetching...');

    const antiSettings = global.db.data.settings[_0x4a2566.user.jid] || {};
...
`;
    ...
    await _0x4a2566.sendMessage(_0x316f52.chat, {
        text: responseMessage,
        contextInfo: {
            mentionedJid: [_0x4a2566.user.jid],
            forwardingScore: 1,
            isForwarded: true
        }
